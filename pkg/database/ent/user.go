...
func (s *mysqlUserRepository) Create(ctx context.Context, u ent.User) error {
...
func (s *mysqlUserRepository) UpdatePassword(ctx context.Context, user ent.User) error {
	//TODO implement me
	panic("implement me")
}
